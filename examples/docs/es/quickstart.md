...
```javascript
import Vue from 'vue'
import ElementUI from 'bbplus-element'
...
```javascript
import Vue from 'vue'
import { Button, Select } from 'bbplus-element'
import App from './App.vue'
...
```JS
import Vue from 'vue'
import Element from 'bbplus-element'
...
```JS
import Vue from 'vue'
import { Button } from 'bbplus-element'
